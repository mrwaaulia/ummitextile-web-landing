  ...
  return (
    <div>
      <footer className="bg-primary dark:bg-secondary">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-20">
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 md:gap-20 sm:gap-6 gap-8 sm:grid-cols-3 ml-10">
              <div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="md:text-sm sm:text-sm text-xs text-white/80 sm:text-center dark:text-gray-400">
              © 2024{" "}
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              <a
                href="#"
                className="text-white/80 hover:text-secondary dark:hover:text-white"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
              ...
              <a
                href="#"
                className="text-white/80 hover:text-secondary dark:hover:text-white ms-5"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
