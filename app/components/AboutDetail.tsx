...
function AboutDetail() {
  return (
    <div>
      <section
        id="about"
        className="bg-gray-100 w-full h-fit md:px-20 md:py-20 px-8 pt-20 pb-20 md:mt-28 mt-20"
      >
        <div className="md:flex gap-14 text-justify justify-center items-center">
          ...
          />
          <div className="md:pt-4 sm:pt-14 pt-12 text-gray-700 md:text-base text-sm">
            <h1 className="md:text-6xl sm:text-4xl text-2xl font-bold text-primary md:mb-12 sm:mb-8 mb-6">
              Tentang Kami
            </h1>
            <p>
            ...
            <div className="w-24 h-2 rounded-sm bg-primary mt-10 md:translate-x-[35rem] sm:translate-x-[32.5rem] translate-x-[14rem]"></div>
          </div>
        </div>
      </section>
    </div>
